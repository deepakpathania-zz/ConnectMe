...
?>
                                                                    <div class="panel-group dshadow" id="panel-<?php echo $rws['user_id']; ?>">
                                                                            ...
                                                                            <div id="panel-element-<?php echo $rws['user_id']; ?>" class="panel-collapse collapse in">
                                                                                <div class="panel-body">
                                                                                    ...
                                                                                    <div class="col-md-8 column">
                                                                                        <div class="col-md-12 column">
                                                                                            <h2 class="black bold"><span><?php echo $rws['user_firstname'];?> <?php echo $rws['user_lastname'];?></span></h2>
                                                                                            <hr>
                                                                                            <p><b>Email id : </b><?php echo $rws['user_email'];?></p>
                                                                                            <p><b>Gender : </b><?php echo $rws['user_gender'];?></p>
                                                                                            <p><b>Short Bio : </b><?php echo $rws['user_shortbio'];?></p>
                                                                                            <hr>
                                                                                        </div>
                                                                                        <div class="col-md-4 column">
                                                                                             <a href="profile.php?user_username=<?php echo $rws['user_username'];?>"><button type="button" class="btn btn-primary zbor mleft">View</button></a>
                                                                                        </div>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
