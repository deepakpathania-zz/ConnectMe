                            ...
                            <div class="form-group">
                                <div class="input-group">
                                    <span class="input-group-addon">
                                        <!-- http://<?php echo $rws['domain_websiteaddress'];?>/user_username= --> Username
                                    </span>
                        ...
                        <div class="row">    
                            <div class="col-lg-8 col-md-offset-0 col-lg-offset-2">
                                <div class="form-gr-1oup centered">
                                    <button class="btn btn-default lshadow black ladda-button zbor" data-style="zoom-in" type="submit"  id="SubmitButton" value="Upload"  name="signup_button"/>Register</button>
                                </div>
                            </div>
                        </div>
                    </form>